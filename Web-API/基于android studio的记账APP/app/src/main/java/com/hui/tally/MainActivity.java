...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button settingBtn,historyBtn,infoBtn;
    ImageButton moreBtn;
    //声明数据源
...
//                break;
            ...
            case R.id.dialog_more_btn_setting:
                Intent it2 = new Intent(this, SettingActivity.class);  //跳转界面
                startActivity(it2);
                break;
            case R.id.dialog_more_btn_record:
                Intent it3 = new Intent(this, HistoryActivity.class);  //跳转界面
                startActivity(it3);
                break;
            case R.id.dialog_more_btn_info:
                Intent it4 = new Intent(this, MonthChartActivity.class);  //跳转界面
                startActivity(it4);
                break;
        }
        if (v == headerView) {
